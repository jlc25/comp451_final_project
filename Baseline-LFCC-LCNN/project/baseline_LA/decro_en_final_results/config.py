...
trn_set_name = 'DECRO_TRAIN_EN'
val_set_name = 'DECRO_DEVELOPMENT-VALIDATION_EN'

# for convenience
#  we will use resources in this directory
# tmp = os.path.dirname(__file__) + '/../DATA/toy_example'
tmp = os.path.dirname(__file__) + '/../../../../../DECRODATA'
...
optional_argument = [tmp + '/en_protocol.txt']
